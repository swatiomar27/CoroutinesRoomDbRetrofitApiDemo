...
open class PreferenceManager constructor(context: Context) : IPreferenceHelper {
    ...
    override fun setLaunchTime(currentTimeMillis: Long) {
        preferences[LAUNCH_TIME] = currentTimeMillis
    }


    override fun getLaunchTime(): Long {
        return preferences[LAUNCH_TIME]  ?: System.currentTimeMillis()
    }
    ...
    companion object {
        ...
        const val LAUNCH_TIME = "launch_time"
    }
}
